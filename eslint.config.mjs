...
export default tseslint.config(
	...
	// Configuration overrides for development files
	{
		files: ['src/development/**/*.ts'],
		rules: {
			'no-console': 'off',
			'n/no-process-exit': 'off',
			'@typescript-eslint/no-explicit-any': 'off',
	...
	// Configuration overrides for game files (sandboxed code)
	{
		files: ['src/app/games/**/*.ts'],
		rules: {
			'no-console': 'off',
			'@typescript-eslint/strict-boolean-expressions': 'off'
		}
	...
	// Configuration overrides for utility files that need flexibility
	{
		files: ['src/app/utils/logger.ts', 'src/app/utils/passportConfig.ts', 'src/app/utils/verifyEnvironmentSecrets.ts', 'src/app/utils/socket.ts', 'src/app/utils/asyncErrorHandler.ts'],
		rules: {
			'@typescript-eslint/no-explicit-any': 'off',
	...
	// Configuration overrides for controllers that need flexibility
	{
		files: ['src/app/controllers/**/*.ts'],
		rules: {
			'@typescript-eslint/no-explicit-any': 'off',
			'@typescript-eslint/strict-boolean-expressions': 'off'
		}
	...
	// Configuration overrides for models
	{
	...
	// Configuration overrides for middleware
	{
	...
	// Configuration overrides for services
	{
	...
	// Configuration overrides for types
	{
